...
public class WheelRecycle {
	...
	// Wheel view
	private com.wheel.WheelView wheel;
	
	/**
	 * Constructor
	 * @param wheel the wheel view
	 */
	public WheelRecycle(com.wheel.WheelView wheel) {
		this.wheel = wheel;
	}
	 ...
	 */
	public int recycleItems(LinearLayout layout, int firstItem, com.wheel.ItemsRange range) {
		int index = firstItem;
