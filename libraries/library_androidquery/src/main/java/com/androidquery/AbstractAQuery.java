...
public abstract class AbstractAQuery<T extends AbstractAQuery<T>> implements Constants {
	 ...
	 * 
	 * The method is designed to avoid recreating an AQuery object repeatedly, such as when in list mAdapter getView method.
	 *
	...
	/**
	 * Set the mAdapter of an AdapterView.
	 *
	 * @param adapter mAdapter
	 * @return self
	 */
	...
	/**
	 * Set the mAdapter of an ExpandableListView.
	 *
	 * @param adapter mAdapter
	 * @return self
	 */
	...
	/**
	 * Notify a ListView that the data of it's mAdapter is changed.
	 *
	 * @return self
	 */
	...
	/**
	 * Gets the selected item if current view is an mAdapter view.
	 *
	 * @return selected
	 */
	...
	/**
	 * Gets the selected item position if current view is an mAdapter view.
	 *
	...
	/**
	 * Return the mContext of activity or view.
	 *	 
	 * @return Context
	 */
	 ...
	 * getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)  of an expandable list mAdapter.
	 * 
	 ...
	 * 
	 * Designed to be used inside 
	 * getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) of an expandable list mAdapter.
	 * 
	 * @param groupPosition the group position of the item
	 ...
	 * until the list stop flinging and the user is focusing on the displaying mItems.
	 *
	 * If the scrolling stops and there are delayed mItems displaying, the getView method will be called again to force
	 * the delayed mItems to be redrawn. During redraw, this method will always return false, thus allowing a particular
	 * resource to be loaded.
	 *
	 * Designed to be used inside getView(int position, View convertView, ViewGroup parent) of an mAdapter.
	 * 
	 * 
	 * <br>
	 * <br>
