...
public class BlurDialogEngine {
    ...
    public void onDismiss() {
        ...
        if (mBlurredBackgroundView != null) {
            ...
            //使用nineold进行动画的向前兼容
            ValueAnimator fadeAnim = ObjectAnimator.ofFloat(mBlurredBackgroundView, "alpha", 1f, 0f);
            fadeAnim.setDuration(mAnimationDuration);
...
//                    }).start();
     ...
     * {@link com.avast.android.dialogs.blur.BlurDialogEngine#DEFAULT_BLUR_DOWN_SCALE_FACTOR}
     * <p/>
     ...
     * {@link com.avast.android.dialogs.blur.BlurDialogEngine#DEFAULT_BLUR_RADIUS}
     *
     ...
     * {@link com.avast.android.dialogs.blur.BlurDialogEngine#DEFAULT_USE_RENDERSCRIPT}
     *
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        final int intHeight = (int) (height - height % 4 + 4);
        final int intWidth = (int) (width - width % 4 + 4);
        overlay = Bitmap.createBitmap(intHeight, intWidth, Bitmap.Config.RGB_565);
    ...
    private class BlurAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            //使用nineold向前兼容
            ViewHelper.setAlpha(mBlurredBackgroundView, 0f);
            mHoldingActivity.getWindow().addContentView(
                    mBlurredBackgroundView,
                    mBlurredBackgroundLayoutParams
            );

            ValueAnimator fadeAnim = ObjectAnimator.ofFloat(mBlurredBackgroundView, "alpha", 0f, 1f);
            fadeAnim.setDuration(mAnimationDuration);
            fadeAnim.setInterpolator(new AccelerateInterpolator());
            fadeAnim.start();
