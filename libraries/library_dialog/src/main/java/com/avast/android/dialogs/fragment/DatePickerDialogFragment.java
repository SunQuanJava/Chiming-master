...
import com.avast.android.dialogs.trick.TrickyDatePicker;
...
public class DatePickerDialogFragment extends BaseDialogFragment {
    ...
    protected BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        ...
        mDatePicker = (TrickyDatePicker) LayoutInflater.from(getActivity()).inflate(R.layout.sdl_datepicker, null);
